...
from .models import SyncConfig, LoggingConfig, ProfileConfig
...
class ConfigManager:
            ...
            try:
                ...
                if 'inherits_from' in profile_data:
                    ...
                    if parent_name in self.profiles:
                        ...
                        merged_config = self._merge_configs(parent_config, profile_data.get('sync_config', {}))
    ...
    def create_default_config(self, output_path: str, template_type: str = "basic") -> str:
        ...
        self.logger.info(f"Created {template_type} configuration template: {output_path}")
        return output_path
